...
public class Recipe {
    ...
    @Column(nullable=true, insertable = false, columnDefinition = " VARCHAR(255) " +
    ...
    public boolean equals(Object o) {
        ...
        return id == recipe.id && Objects.equals(title, recipe.title) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, description, image, category, difficulty,
                servings, cookingTime, preparationTime, ingredients, createdAt, updatedAt);
    }
